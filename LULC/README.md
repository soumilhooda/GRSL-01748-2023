...
5. Data Quality  
    ...
    5.6. Daymet  
    5.7. Ecosystem Spaceborne Thermal Radiometer Experiment on Space Station (ECOSTRESS)  
...
## 1. Request Parameters  
    ...
    Date Completed: 2022-07-27T16:44:59.557597  

    ID: 00f5db8b-3f78-4298-a9e0-c003e3636420  

    Details:  

        Input Vector Name:            __MACOSX/Shape/._telanganashape
        ...
        Layers:  
                ...
                LC_Prop1 (MCD12Q1.006)  
                LC_Prop1_Assessment (MCD12Q1.006)  
                LC_Prop2 (MCD12Q1.006)  
                LC_Prop2_Assessment (MCD12Q1.006)  
    ...
    Version: This request was processed by AppEEARS version 3.6  

## 2. Request File Listing  

**Supporting Files:**  

- Hyderabad-MCD12Q1-006-metadata.xml
- Hyderabad-granule-list.txt
- Hyderabad-request.json
- MCD12Q1-006-QC-lookup.csv
- MCD12Q1-006-QC-Statistics-QA.csv
- MCD12Q1-006-LC-Prop1-Statistics.csv
- MCD12Q1-006-LC-Prop2-Statistics.csv
- MCD12Q1-006-Statistics.csv

**Data Files:**  

Number of Extracted Data Files: 40  
Total Size of Extracted Data Files: 5.71 MB  
...
- Friedl, M., Sulla-Menashe, D. (2019). MCD12Q1 MODIS/Terra+Aqua Land Cover Type Yearly L3 Global 500m SIN Grid V006. NASA EOSDIS Land Processes DAAC. Accessed 2022-07-27 from https://doi.org/10.5067/MODIS/MCD12Q1.006. Accessed July 27, 2022.

## 10. Software Citation  

AppEEARS Team. (2022). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 3.6. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed July 27, 2022. https://appeears.earthdatacloud.nasa.gov
